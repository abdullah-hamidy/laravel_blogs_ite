              ...
              <div class="col-lg-8 col-md-6 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" action="{{route('register.store')}}" enctype="multipart/form-data" method='POST'>
                       @csrf
                      <div class="col-6">
                      ...
                      <div class="col-6">
                        ...
                        <input type="text" name="phone" class="form-control" id="yourPassword" value="{{old('phone')}}">
                        @error('phone')
                                <div class="text-danger text-sm">{{$message}}</div>
                            @enderror
                      </div>
